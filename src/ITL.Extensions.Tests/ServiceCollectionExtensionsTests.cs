...
namespace ITL.Extensions.Tests
{
    public class ServiceCollectionExtensionsTests
    {
        ...
        {
            var collection = new ServiceCollection();
            collection.AddSingleton<ISettings, ISettings2, Settings>();
        ...
        {
            var collection = new ServiceCollection();
            collection.AddSingleton<ISettings, ISettings2, ISettings3, Settings>();
        ...
        {
            var collection = new ServiceCollection();
            collection.AddSingleton<ISettings, ISettings2, ISettings3, ISettings4, Settings>();
        ...
        {
            var collection = new ServiceCollection();
            collection.AddSingleton<ISettings, ISettings2, ISettings3, ISettings4, ISettings5, Settings>();
        ...
        {
            var collection = new ServiceCollection();
            collection.AddSingleton<ISettings, ISettings2, ISettings3, ISettings4, ISettings5, ISettings6, Settings>();
        ...
        {
            var collection = new ServiceCollection();
            collection.AddSingleton<ISettings, ISettings2, ISettings3, ISettings4, ISettings5, ISettings6, ISettings7, Settings>();
        ...
        {
            var collection = new ServiceCollection();
            collection.AddSingleton<ISettings, ISettings2, ISettings3, ISettings4, ISettings5, ISettings6, ISettings7, ISettings8, Settings>();
        ...
        {
            var collection = new ServiceCollection();
            collection.AddSingleton<ISettings, ISettings2, ISettings3, ISettings4, ISettings5, ISettings6, ISettings7, ISettings8, ISettings9, Settings>();
        ...
        {
            var collection = new ServiceCollection();
            collection.AddSingleton<ISettings, ISettings2, ISettings3, ISettings4, ISettings5, ISettings6, ISettings7, ISettings8, ISettings9, ISettings10, Settings>();
        ...
        {
            var collection = new ServiceCollection();
            collection.AddSingleton<ISettings, ISettings2, ISettings3, ISettings4, ISettings5, ISettings6, ISettings7, ISettings8, ISettings9, ISettings10, ISettings11, Settings>();
        ...
        {
            var collection = new ServiceCollection();
            collection.AddSingleton<ISettings, ISettings2, ISettings3, ISettings4, ISettings5, ISettings6, ISettings7, ISettings8, ISettings9, ISettings10, ISettings11, ISettings12, Settings>();
