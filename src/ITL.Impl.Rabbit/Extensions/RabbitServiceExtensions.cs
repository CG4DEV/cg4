using ITL.Impl.Rabbit.Consumer;
...
public static class RabbitServiceExtensions
{
    ...
    public static void AddITLRabbitBasicServices(this IServiceCollection services, Action<RabbitConfigSettings> configSettings)
    {
